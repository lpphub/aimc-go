...
func (m *ApprovalMiddleware) checkApproval(ctx context.Context, args string) (storedArgs string, result *types.ApprovalResult) {
	...
	_, _, result = tool.GetResumeContext[*types.ApprovalResult](ctx)
...
func (m *ApprovalMiddleware) WrapInvokableToolCall(_ context.Context, endpoint adk.InvokableToolCallEndpoint, tCtx *adk.ToolContext) (adk.InvokableToolCallEndpoint, error) {
	...
	return func(ctx context.Context, args string, opts ...tool.Option) (string, error) {
		...
		if result == nil {
			return "", tool.StatefulInterrupt(ctx, &types.ApprovalInfo{
				ToolName:        tCtx.Name,
...
func (m *ApprovalMiddleware) WrapStreamableToolCall(_ context.Context, endpoint adk.StreamableToolCallEndpoint, tCtx *adk.ToolContext) (adk.StreamableToolCallEndpoint, error) {
	...
	return func(ctx context.Context, args string, opts ...tool.Option) (*schema.StreamReader[string], error) {
		...
		if result == nil {
			return nil, tool.StatefulInterrupt(ctx, &types.ApprovalInfo{
				ToolName:        tCtx.Name,
				ArgumentsInJSON: storedArgs,
			}, storedArgs)
		}
